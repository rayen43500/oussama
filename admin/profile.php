<?php
// admin/profile.php
$pageTitle = "Profil Administrateur";
    ...
    if (empty($firstName) || empty($lastName) || empty($phone) || !$email) {
        ...
        try {
            ...
            if ($emailStmt->fetch()) {
                ...
                log_activity($userId, 'MISE_A_JOUR_PROFIL', "Mise à jour du profil administrateur.");
                $successMsg = "✅ Vos informations ont été mises à jour avec succès.";
            }
        } catch (PDOException $e) {
            $errorMsg = "⚠️ Une erreur technique est survenue.";
        }
    }
}
    ...
    if (empty($oldPass) || empty($newPass) || empty($confirmPass)) {
        ...
        try {
            ...
            if (password_verify($oldPass, $currentPass)) {
                ...
                log_activity($userId, 'MODIFICATION_MOT_DE_PASSE', "Modification du mot de passe administrateur.");
                $successMsg = "✅ Votre mot de passe a été modifié avec succès.";
            } else {
                $errorMsg = "⚠️ L'ancien mot de passe saisi est incorrect.";
            }
        } catch (PDOException $e) {
            $errorMsg = "⚠️ Erreur technique.";
        }
    }
}
...
<div class="dashboard-wrapper">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="<?php echo $baseUrl; ?>admin/reclamations.php" class="sidebar-link">
                <i class="fas fa-folder-open"></i> Réclamations
            </a>
            <a href="<?php echo $baseUrl; ?>admin/categories.php" class="sidebar-link">
            ...
            <a href="<?php echo $baseUrl; ?>admin/profile.php" class="sidebar-link active">
    ...
    <main class="main-content">
        ...
        <header class="main-header">
            <div>
                ...
                <h2>Mon Profil Administrateur ⚙️</h2>
                <p style="color: var(--text-muted); font-size: 0.95rem;">Gérez vos identifiants d'accès système.</p>
            </div>
        </header>
        ...
        <div class="dashboard-grid">
            <div class="card">
                <h3 style="margin-bottom: 1.5rem;"><i class="fas fa-user-shield"></i> Profil Système</h3>
                ...
                <form action="profile.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="email" class="form-label">Adresse Email Système</label>
            ...
            <div class="card">
                <h3 style="margin-bottom: 1.5rem;"><i class="fas fa-key"></i> Sécurité Admin</h3>
                ...
                <form action="profile.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            <input type="password" id="old_password" name="old_password" class="form-control" required style="padding-right: 45px;">
                    ...
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            <input type="password" id="new_password" name="new_password" class="form-control" required style="padding-right: 45px;">
