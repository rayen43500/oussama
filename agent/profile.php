    ...
    if (empty($firstName) || empty($lastName) || empty($phone) || !$email) {
        ...
        try {
            ...
            if ($emailStmt->fetch()) {
                ...
                log_activity($userId, 'MISE_A_JOUR_PROFIL', "Mise à jour des informations de profil agent.");
    ...
    if (empty($oldPass) || empty($newPass) || empty($confirmPass)) {
        ...
        try {
            ...
            if (password_verify($oldPass, $currentPass)) {
                ...
                log_activity($userId, 'MODIFICATION_MOT_DE_PASSE', "Modification du mot de passe agent.");
...
<div class="dashboard-wrapper">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="<?php echo $baseUrl; ?>agent/reclamations.php" class="sidebar-link">
                <i class="fas fa-tasks"></i> Réclamations Assignées
            </a>
            <a href="<?php echo $baseUrl; ?>agent/profile.php" class="sidebar-link active">
    ...
    <main class="main-content">
        ...
        <header class="main-header">
            <div>
                ...
                <h2>Mon Profil Agent ⚙️</h2>
                <p style="color: var(--text-muted); font-size: 0.95rem;">Mettez à jour vos identifiants professionnels.</p>
            </div>
        </header>
        ...
        <div class="dashboard-grid">
            <div class="card">
                <h3 style="margin-bottom: 1.5rem;"><i class="fas fa-user-tie"></i> Profil Collaborateur</h3>
            ...
            <div class="card">
                <h3 style="margin-bottom: 1.5rem;"><i class="fas fa-key"></i> Sécurité d'Accès</h3>
